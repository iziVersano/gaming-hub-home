      ...
      <main className="container px-4 md:px-6 pt-20 md:pt-24 pb-4 flex-1">
        ...
        <section className="pt-6 pb-2 md:pt-10 md:pb-4">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="product-card p-8 flex flex-col items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-[#25D366] flex items-center justify-center">
                <WhatsAppIcon className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-2xl font-bold">{t('contact.cta.title')}</h2>
              <p className="text-muted-foreground">{t('contact.cta.subtitle')}</p>
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                <a
                  href="https://wa.me/972522768607?text=Hi%20Consoltech,%20I%27d%20like%20to%20inquire%20about%20your%20products."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-hero inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-semibold"
                  aria-label={t('contact.cta.whatsappButton')}
                >
                ...
                <a
                  ...
                  aria-label={t('contact.cta.emailButton')}
                >
