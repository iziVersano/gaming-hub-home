      ...
      <div className="relative z-[1] w-full px-4 pt-[74px] md:pt-0 md:max-w-7xl md:mx-auto md:px-8 text-right" dir="rtl">
        <div className="space-y-2 items-end w-full">
          ...
          <div className="flex md:hidden flex-col items-stretch w-full mb-1">
            ...
            <div className="w-full flex items-start" style={{ direction: 'ltr' }}>
              <Gamepad2 style={{ width: '18vw', height: '18vw', maxWidth: '4.5rem', maxHeight: '4.5rem', flexShrink: 0, color: "hsl(195 100% 88%)", filter: "drop-shadow(0 0 6px hsl(195 100% 70%)) drop-shadow(0 0 16px hsl(195 100% 55%)) drop-shadow(0 0 30px hsl(195 100% 45%))" }} />
              <span className="logo-text whitespace-nowrap" style={{ direction: 'rtl', fontSize: 'clamp(2.8rem,13.5vw,4.5rem)', lineHeight: '1', letterSpacing: '0.04em', marginRight: 0 }}>
